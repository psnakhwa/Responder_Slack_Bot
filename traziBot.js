...
controller.hears('assign_issue',['mention', 'direct_mention','direct_message'], function(bot,message) 
{ 
    helper.callGetCollaborator();
    console.log(message);
    bot.reply(message,"this is the list of collboratoras");
    //findRelative
});
